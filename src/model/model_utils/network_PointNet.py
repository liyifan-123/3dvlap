...
class STN3d(nn.Module):
    def __init__(self, device, point_size=3):
...
class PointNetfeat(BaseNetwork):
    def __init__(self, device, global_feat = True, input_transform = True, feature_transform = False, 
        ...
        if input_transform:
            ...
            self.stn = STN3d(device, point_size=point_size)
