...
from src.model.SGFN_MMG.model_fully_sggpoint import SGGpoint
from src.utils import op_utils
from src.utils.eva_utils_acc import get_mean_recall, get_zero_shot_recall, get_head_body_tail
from src.utils.eval_utils_recall import evaluate_triplet_recallk, handle_mean_recall
...
class MMGNet():
    def __init__(self, config):
        ...
        if config.MODE  == 'train':
            ...
            self.dataset_train = build_dataset(self.config,split_type='train_scans', shuffle_objs=True,
                                               ...
                                               use_normal=mconfig.USE_NORMAL, Type="ws")
    ...
    def train(self):
        ...
        while(keep_training):
            ...
            for items in loader:
                ...
                # flops, params = profile(self.model, inputs=(obj_points, edge_indices.t().contiguous(),descriptor, batch_ids, True))
    ...
    def validation(self, debug_mode = False):
        ...
        result_print = Result_print(self.config.exp, self.dataset_valid.classNames, self.dataset_valid.relationNames, self.config.dataset.use_rio27_dataset)
